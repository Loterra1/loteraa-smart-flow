...
export default function DatasetEntryPage() {
   ...
   const [selectedDataset, setSelectedDataset] = useState<DatasetFile | null>(
      null
   );
            ...
            <div className="container mx-auto px-4 py-4 sm:py-8">
               <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 gap-4 sm:gap-0">
                  <div>
                     ...
                     <p className="text-white/70 text-sm sm:text-base">
                        Submit and manage your datasets for Smart contract
                        verification and onchain to earn rewards
                     </p>
                  </div>
                  <Button
               ...
               <div className="bg-loteraa-gray/10 backdrop-blur-md border border-loteraa-gray/20 rounded-xl p-12 text-center mb-8">
                  ...
                  <p className="text-white/70 mb-6 max-w-md mx-auto">
                     Start by submitting your first dataset for verification and
                     earn rewards through our decentralized verification system.
                  </p>
                  <Button
                     ...
                     {datasets.map((dataset) => (
                        ...
                        >
                           <div className="flex justify-between items-start mb-2">
                              <h3 className="font-medium text-white group-hover:text-loteraa-teal transition-colors">
                                 {dataset.name}
                              </h3>
