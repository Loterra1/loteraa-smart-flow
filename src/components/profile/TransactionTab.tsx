...
import { ArrowUpRight, ArrowDownRight, Coins, Download, ExternalLink } from "lucide-react";
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div>{format(new Date(selectedTransaction.created_at), 'MMM dd, yyyy HH:mm')}</div>
                </div>
              </div>
