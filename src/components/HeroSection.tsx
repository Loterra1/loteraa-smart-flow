      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
            <span className="gradient-text animate-fade-in animation-delay-500">Connecting IoT</span> to <br /> 
            <span className="gradient-text animate-fade-in animation-delay-1000">Blockchain</span> 
            <span className="animate-fade-in animation-delay-1500"> Seamlessly</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-2xl animate-fade-in animation-delay-2000">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in animation-delay-2500 mb-12">
